...
Scene* TestScene13::createScene()
{
    return TestScene13::create();
}

// on "init" you need to initialize your instance
bool TestScene13::init()
{
    //////////////////////////////
    // 1. super init first
    if (!Scene::init())
...
//Add UI subsystem
void TestScene13::addUISubsystem()
{
    //Add a solid rect
