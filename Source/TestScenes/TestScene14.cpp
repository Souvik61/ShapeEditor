...
Scene* TestScene14::createScene()
{
    return TestScene14::create();
}

// on "init" you need to initialize your instance
bool TestScene14::init()
{
    //////////////////////////////
    // 1. super init first
    if (!Scene::init())
...
void TestScene14::update(float dt)
{
    Scene::update(dt);

}

void TestScene14::onEnter()
{
    Scene::onEnter();
...
//Add UI subsystem
void TestScene14::addUISubsystem()
{
    //Add a solid rect
...
void TestScene14::addCloseButton()
{
    auto closeItem = MenuItemImage::create(
        "CloseNormal.png",
        "CloseSelected.png",
        CC_CALLBACK_1(TestScene14::menuCloseCallback, this));
...
void TestScene14::menuCloseCallback(Ref* pSender)
{
