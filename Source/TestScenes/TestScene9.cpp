...
Scene* TestScene9::createScene()
{
    return TestScene9::create();
}

// on "init" you need to initialize your instance
bool TestScene9::init()
{
    //////////////////////////////
    // 1. super init first
    if (!Scene::init())
...
//Add UI subsystem
void TestScene9::addUISubsystem()
{
...
void TestScene9::addCloseButton()
{
    auto closeItem = MenuItemImage::create(
        "CloseNormal.png",
        "CloseSelected.png",
        CC_CALLBACK_1(TestScene9::menuCloseCallback, this));
...
void TestScene9::menuCloseCallback(Ref* pSender)
{
