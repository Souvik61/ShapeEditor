...
Scene* TestScene10::createScene()
{
    return TestScene10::create();
}

// on "init" you need to initialize your instance
bool TestScene10::init()
{
    //////////////////////////////
    // 1. super init first
    if (!Scene::init())
...
//Add UI subsystem
void TestScene10::addUISubsystem()
{
...
void TestScene10::addCloseButton()
{
    auto closeItem = MenuItemImage::create(
        "CloseNormal.png",
        "CloseSelected.png",
        CC_CALLBACK_1(TestScene10::menuCloseCallback, this));
...
void TestScene10::menuCloseCallback(Ref* pSender)
{
