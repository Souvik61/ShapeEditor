...
void EditionInputProcessorv3::onMouseUp(CustomMouseEvent e)
{
    ...
    //}
    //else if (_editorPanel->editorManager->mSel.isValid()) //If has a valid mouse selection on mouse up
    //{
    //    _editorPanel->editorManager->selectPointsInMouseSelection();
    //}
    //else {
    //    _editorPanel->editorManager->selectedPoints.clear();
    //}
    //
    //_editorPanel->editorManager->mSel.setZero();
    //_editorPanel->editorManager->mSel.setValid(false);
    //_touchDown = false;
...
void EditionInputProcessorv3::onMouseMoved(CustomMouseEvent e)
{
    ...
    //
    //    _editorPanel->editorManager->validateNearestPoint(p);
    //}
}
...
void EditionInputProcessorv3::onMouseDragged(CustomMouseEvent e)
{
    ...
    //if (model == nullptr) return;
    //
    //auto editMan = _editorPanel->editorManager;
    //
    //if (draggedPoint != nullptr) {
    //    
    //    Vec2 p = e.mEvent->getLocationInView();
    ...
    //
    //    _editorPanel->editorManager->mSel.setValid(true);
    //    _editorPanel->editorManager->mSel.p2.set(p);
    //
    //}
...
void EditionInputProcessorv3::onKeyDown(ax::EventKeyboard::KeyCode k, ax::Event* e)
{
    ...
    //{
    //    _editorPanel->editorManager->removeSelectedPoints();
    //}
}
